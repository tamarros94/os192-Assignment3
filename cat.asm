...
00000412 <update_protected_pages>:
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 457:	f7 f1                	div    %ecx
 459:	0f b6 92 c0 0a 00 00 	movzbl 0xac0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb b8 0a 00 00       	mov    $0xab8,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 691:	a1 00 0f 00 00       	mov    0xf00,%eax
free(void *ap) {
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
    freep = p;
 6cf:	a3 00 0f 00 00       	mov    %eax,0xf00
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
free(void *ap) {
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 70a:	a3 00 0f 00 00       	mov    %eax,0xf00
        p->s.size += bp->s.size;
 ...
 721:	3d ff 0f 00 00       	cmp    $0xfff,%eax
{
 ...
 72a:	89 c3                	mov    %eax,%ebx
    if(nu < 4096 && !pmalloced)
 72c:	77 52                	ja     780 <morecore+0x60>
 72e:	83 e2 01             	and    $0x1,%edx
 731:	75 4d                	jne    780 <morecore+0x60>
 ...
 740:	53                   	push   %ebx
 741:	68 d1 0a 00 00       	push   $0xad1
 746:	6a 01                	push   $0x1
 748:	e8 73 fd ff ff       	call   4c0 <printf>
    p = sbrk(nu * sizeof(Header));
 74d:	89 34 24             	mov    %esi,(%esp)
 750:	e8 95 fc ff ff       	call   3ea <sbrk>
    if(p == (char*)-1)
 755:	83 c4 10             	add    $0x10,%esp
 758:	83 f8 ff             	cmp    $0xffffffff,%eax
 75b:	74 33                	je     790 <morecore+0x70>
        return 0;
    hp = (Header*)p;
    hp->s.size = nu;
 ...
 766:	50                   	push   %eax
 767:	e8 24 ff ff ff       	call   690 <free>
    return freep;
 76c:	a1 00 0f 00 00       	mov    0xf00,%eax
 ...
 780:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 787:	eb b4                	jmp    73d <morecore+0x1d>
 789:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        return 0;
 790:	31 c0                	xor    %eax,%eax
 792:	eb e0                	jmp    774 <morecore+0x54>
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 75 08             	mov    0x8(%ebp),%esi
    ...
    printf(1, "nbytes:%d\n",nbytes);
 7ac:	56                   	push   %esi
 7ad:	68 e4 0a 00 00       	push   $0xae4
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7b2:	83 c6 07             	add    $0x7,%esi
    printf(1, "nbytes:%d\n",nbytes);
 7b5:	6a 01                	push   $0x1
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ba:	83 c6 01             	add    $0x1,%esi
    printf(1, "nbytes:%d\n",nbytes);
 7bd:	e8 fe fc ff ff       	call   4c0 <printf>
    if((prevp = freep) == 0){
 7c2:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
 7c8:	83 c4 10             	add    $0x10,%esp
 7cb:	85 ff                	test   %edi,%edi
 7cd:	0f 84 d5 00 00 00    	je     8a8 <malloc+0x108>
 7d3:	8b 1f                	mov    (%edi),%ebx
 7d5:	8b 53 04             	mov    0x4(%ebx),%edx
 7d8:	eb 0f                	jmp    7e9 <malloc+0x49>
 ...
 7e2:	89 df                	mov    %ebx,%edi
 7e4:	8b 50 04             	mov    0x4(%eax),%edx
 7e7:	89 c3                	mov    %eax,%ebx
 7e9:	83 ec 04             	sub    $0x4,%esp
 7ec:	52                   	push   %edx
 7ed:	68 03 0b 00 00       	push   $0xb03
 7f2:	6a 01                	push   $0x1
 7f4:	e8 c7 fc ff ff       	call   4c0 <printf>
        if(p->s.size >= nunits){
 7f9:	8b 43 04             	mov    0x4(%ebx),%eax
 7fc:	83 c4 10             	add    $0x10,%esp
 7ff:	39 f0                	cmp    %esi,%eax
 801:	73 3d                	jae    840 <malloc+0xa0>
            }
        ...
        if(p == freep){
 803:	39 1d 00 0f 00 00    	cmp    %ebx,0xf00
 809:	75 d5                	jne    7e0 <malloc+0x40>
            printf(1, "calling morecore: 0x%x\n", p);
 80b:	83 ec 04             	sub    $0x4,%esp
 80e:	53                   	push   %ebx
 80f:	68 67 0b 00 00       	push   $0xb67
 814:	6a 01                	push   $0x1
 816:	e8 a5 fc ff ff       	call   4c0 <printf>
            if((p = morecore(nunits,0)) == 0)
 81b:	31 d2                	xor    %edx,%edx
 81d:	89 f0                	mov    %esi,%eax
 81f:	e8 fc fe ff ff       	call   720 <morecore>
 824:	83 c4 10             	add    $0x10,%esp
 827:	85 c0                	test   %eax,%eax
 829:	89 c3                	mov    %eax,%ebx
 82b:	75 b3                	jne    7e0 <malloc+0x40>
                return 0;
    }}
}
 ...
 839:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits){
 840:	74 46                	je     888 <malloc+0xe8>
                printf(1,"p->s.size (%d) =! nunits(%d)\n",p->s.size,nunits);
 842:	56                   	push   %esi
 843:	50                   	push   %eax
 844:	68 3a 0b 00 00       	push   $0xb3a
 849:	6a 01                	push   $0x1
 84b:	e8 70 fc ff ff       	call   4c0 <printf>
                p->s.size -= nunits;
 ...
 858:	89 43 04             	mov    %eax,0x4(%ebx)
                p += p->s.size;
 85b:	8d 1c c3             	lea    (%ebx,%eax,8),%ebx
                p->s.size = nunits;
 85e:	89 73 04             	mov    %esi,0x4(%ebx)
            printf(1,"returning p+1\n");
 861:	83 ec 08             	sub    $0x8,%esp
 864:	68 58 0b 00 00       	push   $0xb58
 869:	6a 01                	push   $0x1
 86b:	e8 50 fc ff ff       	call   4c0 <printf>
            freep = prevp;
 870:	89 3d 00 0f 00 00    	mov    %edi,0xf00
            return (void*)(p + 1);
 876:	83 c4 10             	add    $0x10,%esp
}
 879:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return (void*)(p + 1);
 87c:	8d 43 08             	lea    0x8(%ebx),%eax
}
 87f:	5b                   	pop    %ebx
 880:	5e                   	pop    %esi
 881:	5f                   	pop    %edi
 ...
 88b:	56                   	push   %esi
 88c:	68 1f 0b 00 00       	push   $0xb1f
 891:	6a 01                	push   $0x1
 893:	e8 28 fc ff ff       	call   4c0 <printf>
                prevp->s.ptr = p->s.ptr;}
 898:	8b 03                	mov    (%ebx),%eax
 89a:	83 c4 10             	add    $0x10,%esp
 89d:	89 07                	mov    %eax,(%edi)
 89f:	eb c0                	jmp    861 <malloc+0xc1>
 8a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"prevp = freep == 0\n");
 8a8:	83 ec 08             	sub    $0x8,%esp
        base.s.size = 0;
 8ab:	bb 04 0f 00 00       	mov    $0xf04,%ebx
        printf(1,"prevp = freep == 0\n");
 8b0:	68 ef 0a 00 00       	push   $0xaef
 8b5:	6a 01                	push   $0x1
        base.s.ptr = freep = prevp = &base;
 8b7:	89 df                	mov    %ebx,%edi
        printf(1,"prevp = freep == 0\n");
 8b9:	e8 02 fc ff ff       	call   4c0 <printf>
        base.s.ptr = freep = prevp = &base;
 8be:	c7 05 00 0f 00 00 04 	movl   $0xf04,0xf00
 8c5:	0f 00 00 
 8c8:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 8cf:	0f 00 00 
        base.s.size = 0;
 8d2:	83 c4 10             	add    $0x10,%esp
 8d5:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 8dc:	00 00 00 
 8df:	31 d2                	xor    %edx,%edx
 8e1:	e9 03 ff ff ff       	jmp    7e9 <malloc+0x49>
...
pmalloc(void) {
    ...
    if ((prevp = freep) == 0) {
 8f0:	8b 0d 00 0f 00 00    	mov    0xf00,%ecx
pmalloc(void) {
 8f6:	55                   	push   %ebp
 ...
 8fd:	0f 84 95 00 00 00    	je     998 <pmalloc+0xa8>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 903:	8b 19                	mov    (%ecx),%ebx
        if (p->s.size >= ((4096 / 8)*2)) {
 905:	8b 53 04             	mov    0x4(%ebx),%edx
 908:	81 fa ff 03 00 00    	cmp    $0x3ff,%edx
 90e:	76 1d                	jbe    92d <pmalloc+0x3d>
 910:	eb 3f                	jmp    951 <pmalloc+0x61>
 912:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 918:	8b 03                	mov    (%ebx),%eax
        if (p->s.size >= ((4096 / 8)*2)) {
 91a:	8b 50 04             	mov    0x4(%eax),%edx
 91d:	81 fa ff 03 00 00    	cmp    $0x3ff,%edx
 923:	77 30                	ja     955 <pmalloc+0x65>
 925:	8b 0d 00 0f 00 00    	mov    0xf00,%ecx
 92b:	89 c3                	mov    %eax,%ebx
            ...
            if (p == freep) {
 92d:	39 cb                	cmp    %ecx,%ebx
 92f:	75 e7                	jne    918 <pmalloc+0x28>
                if ((p = morecore(nunits, 1)) == 0) {
 931:	ba 01 00 00 00       	mov    $0x1,%edx
 936:	b8 00 02 00 00       	mov    $0x200,%eax
 93b:	e8 e0 fd ff ff       	call   720 <morecore>
 940:	85 c0                	test   %eax,%eax
 942:	89 c3                	mov    %eax,%ebx
 944:	75 d2                	jne    918 <pmalloc+0x28>
                    return 0;
                }
            }
        }
 ...
 953:	89 cb                	mov    %ecx,%ebx
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
 955:	81 e2 00 fe ff ff    	and    $0xfffffe00,%edx
            set_flag((uint) (p + 1), PTE_1, 1);
 95b:	83 ec 04             	sub    $0x4,%esp
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
 95e:	81 ea 01 02 00 00    	sub    $0x201,%edx
            p += p->s.size;
 964:	8d 34 d0             	lea    (%eax,%edx,8),%esi
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
 967:	89 50 04             	mov    %edx,0x4(%eax)
            set_flag((uint) (p + 1), PTE_1, 1);
 96a:	83 c6 08             	add    $0x8,%esi
            p->s.size = nunits;
 96d:	c7 46 fc 00 02 00 00 	movl   $0x200,-0x4(%esi)
            set_flag((uint) (p + 1), PTE_1, 1);
 974:	6a 01                	push   $0x1
 976:	68 00 04 00 00       	push   $0x400
 97b:	56                   	push   %esi
 97c:	e8 89 fa ff ff       	call   40a <set_flag>
            freep = prevp;
 981:	89 1d 00 0f 00 00    	mov    %ebx,0xf00
            return (void *) (p + 1);
 987:	83 c4 10             	add    $0x10,%esp
}
 98a:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 994:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.size = 0;
 998:	b9 04 0f 00 00       	mov    $0xf04,%ecx
        base.s.ptr = freep = prevp = &base;
 99d:	c7 05 00 0f 00 00 04 	movl   $0xf04,0xf00
 9a4:	0f 00 00 
 9a7:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 9ae:	0f 00 00 
        base.s.size = 0;
 9b1:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 9b8:	00 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 9bb:	89 cb                	mov    %ecx,%ebx
 9bd:	e9 6b ff ff ff       	jmp    92d <pmalloc+0x3d>
 9c2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 9c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000009d0 <protect_page>:
...
protect_page(void* ap){
 ...
 9da:	8d 43 f8             	lea    -0x8(%ebx),%eax
 9dd:	a9 ff 0f 00 00       	test   $0xfff,%eax
 9e2:	75 3c                	jne    a20 <protect_page+0x50>
        return -1;
    }
    int flags = get_flags((uint)ap);
 9e4:	83 ec 0c             	sub    $0xc,%esp
 9e7:	53                   	push   %ebx
 9e8:	e8 15 fa ff ff       	call   402 <get_flags>
    if (flags & PTE_1) {
 9ed:	83 c4 10             	add    $0x10,%esp
 9f0:	f6 c4 04             	test   $0x4,%ah
 9f3:	74 2b                	je     a20 <protect_page+0x50>
        set_flag((uint) ap, PTE_W, 0);
 9f5:	83 ec 04             	sub    $0x4,%esp
 9f8:	6a 00                	push   $0x0
 9fa:	6a 02                	push   $0x2
 9fc:	53                   	push   %ebx
 9fd:	e8 08 fa ff ff       	call   40a <set_flag>
        update_protected_pages(1);
 a02:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a09:	e8 04 fa ff ff       	call   412 <update_protected_pages>
        return 1;
 ...
 a25:	eb ef                	jmp    a16 <protect_page+0x46>
...
int pfree(void *ap){
 ...
 a37:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    int flags = get_flags((uint) ap);
 a3a:	53                   	push   %ebx
 a3b:	e8 c2 f9 ff ff       	call   402 <get_flags>
    if (!(flags & PTE_W)) set_flag((uint) ap, PTE_W, 1);
 a40:	83 c4 10             	add    $0x10,%esp
 a43:	a8 02                	test   $0x2,%al
 a45:	75 31                	jne    a78 <pfree+0x48>
 a47:	83 ec 04             	sub    $0x4,%esp
 a4a:	6a 01                	push   $0x1
 a4c:	6a 02                	push   $0x2
 a4e:	53                   	push   %ebx
 a4f:	e8 b6 f9 ff ff       	call   40a <set_flag>
    else
        return -1;

    free(ap);
 a54:	89 1c 24             	mov    %ebx,(%esp)
 a57:	e8 34 fc ff ff       	call   690 <free>
    update_protected_pages(0);
 a5c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 a63:	e8 aa f9 ff ff       	call   412 <update_protected_pages>
    return 1;
 ...
 a75:	8d 76 00             	lea    0x0(%esi),%esi
        return -1;
 a78:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a7d:	eb f1                	jmp    a70 <pfree+0x40>
