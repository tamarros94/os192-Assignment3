...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      38:	80 3d 62 1c 00 00 20 	cmpb   $0x20,0x1c62
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 60 1c 00 00       	push   $0x1c60
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d 60 1c 00 00 63 	cmpb   $0x63,0x1c60
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 61 1c 00 00 64 	cmpb   $0x64,0x1c61
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 63 1c 00 00       	push   $0x1c63
      ec:	68 d9 14 00 00       	push   $0x14d9
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 30 14 00 00       	push   $0x1430
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 cd 14 00 00       	push   $0x14cd
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 e8 14 00 00 	jmp    *0x14e8(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 3a 14 00 00       	push   $0x143a
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 4a 14 00 00       	push   $0x144a
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 33 14 00 00       	push   $0x1433
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 5a 14 00 00       	push   $0x145a
     ...
     2d8:	68 5f 14 00 00       	push   $0x145f
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 5a 14 00 00       	push   $0x145a
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 44 1c 00 00       	push   $0x1c44
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 44 1c 00 00       	push   $0x1c44
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 3c 1c 00 00       	push   $0x1c3c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 44 1c 00 00       	push   $0x1c44
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 44 1c 00 00       	push   $0x1c44
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 81 14 00 00       	push   $0x1481
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 64 14 00 00       	push   $0x1464
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 84 14 00 00       	push   $0x1484
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 9b 14 00 00       	push   $0x149b
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 8d 14 00 00       	push   $0x148d
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 86 14 00 00       	push   $0x1486
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 a0 14 00 00       	push   $0x14a0
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 a2 14 00 00       	push   $0x14a2
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 9e 14 00 00       	push   $0x149e
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 84 14 00 00       	push   $0x1484
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 c0 14 00 00       	push   $0x14c0
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 00 15 00 00 	jmp    *0x1500(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 b7 15 00 00       	push   $0x15b7
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 c2 14 00 00       	push   $0x14c2
     aa6:	6a 02                	push   $0x2
     aa8:	e8 c3 03 00 00       	call   e70 <printf>
    panic("syntax");
     aad:	c7 04 24 86 14 00 00 	movl   $0x1486,(%esp)
...
00000dc2 <update_protected_pages>:
     ...
     dd9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e07:	f7 f1                	div    %ecx
     e09:	0f b6 92 20 15 00 00 	movzbl 0x1520(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1024:	e9 8f fe ff ff       	jmp    eb8 <printf+0x48>
          s = "(null)";
    1029:	bb 18 15 00 00       	mov    $0x1518,%ebx
        while(*s != 0){
...
free(void *ap) {
    ...
    1041:	a1 c4 1c 00 00       	mov    0x1cc4,%eax
free(void *ap) {
    ...
    freep = p;
    107f:	a3 c4 1c 00 00       	mov    %eax,0x1cc4
}
    1084:	5b                   	pop    %ebx
    1085:	5e                   	pop    %esi
    1086:	5f                   	pop    %edi
...
free(void *ap) {
    ...
    freep = p;
    10ba:	a3 c4 1c 00 00       	mov    %eax,0x1cc4
        p->s.size += bp->s.size;
...
morecore(uint nu, int pmalloced)
{
    ...
    10d1:	3d ff 0f 00 00       	cmp    $0xfff,%eax
{
    10d6:	89 e5                	mov    %esp,%ebp
    10d8:	56                   	push   %esi
    10d9:	53                   	push   %ebx
    10da:	89 c3                	mov    %eax,%ebx
    if(nu < 4096 && !pmalloced)
    10dc:	77 52                	ja     1130 <morecore+0x60>
    10de:	83 e2 01             	and    $0x1,%edx
    10e1:	75 4d                	jne    1130 <morecore+0x60>
    10e3:	be 00 80 00 00       	mov    $0x8000,%esi
        nu = 4096;
    10e8:	bb 00 10 00 00       	mov    $0x1000,%ebx
    printf(1 , "enter morecore %d\n", nu);
    10ed:	83 ec 04             	sub    $0x4,%esp
    10f0:	53                   	push   %ebx
    10f1:	68 31 15 00 00       	push   $0x1531
    10f6:	6a 01                	push   $0x1
    10f8:	e8 73 fd ff ff       	call   e70 <printf>
    p = sbrk(nu * sizeof(Header));
    10fd:	89 34 24             	mov    %esi,(%esp)
    1100:	e8 95 fc ff ff       	call   d9a <sbrk>
    if(p == (char*)-1)
    1105:	83 c4 10             	add    $0x10,%esp
    1108:	83 f8 ff             	cmp    $0xffffffff,%eax
    110b:	74 33                	je     1140 <morecore+0x70>
        return 0;
    hp = (Header*)p;
    hp->s.size = nu;
    110d:	89 58 04             	mov    %ebx,0x4(%eax)
    free((void*)(hp + 1));
    1110:	83 ec 0c             	sub    $0xc,%esp
    1113:	83 c0 08             	add    $0x8,%eax
    1116:	50                   	push   %eax
    1117:	e8 24 ff ff ff       	call   1040 <free>
    return freep;
    111c:	a1 c4 1c 00 00       	mov    0x1cc4,%eax
    ...
    1130:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    1137:	eb b4                	jmp    10ed <morecore+0x1d>
    1139:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        return 0;
    1140:	31 c0                	xor    %eax,%eax
    1142:	eb e0                	jmp    1124 <morecore+0x54>
...
malloc(uint nbytes)
{
    ...
    1159:	8b 75 08             	mov    0x8(%ebp),%esi
    Header *p, *prevp;
    uint nunits;
    printf(1, "nbytes:%d\n",nbytes);
    115c:	56                   	push   %esi
    115d:	68 44 15 00 00       	push   $0x1544
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1162:	83 c6 07             	add    $0x7,%esi
    printf(1, "nbytes:%d\n",nbytes);
    1165:	6a 01                	push   $0x1
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1167:	c1 ee 03             	shr    $0x3,%esi
    116a:	83 c6 01             	add    $0x1,%esi
    printf(1, "nbytes:%d\n",nbytes);
    116d:	e8 fe fc ff ff       	call   e70 <printf>
    if((prevp = freep) == 0){
    1172:	8b 3d c4 1c 00 00    	mov    0x1cc4,%edi
    1178:	83 c4 10             	add    $0x10,%esp
    117b:	85 ff                	test   %edi,%edi
    117d:	0f 84 d5 00 00 00    	je     1258 <malloc+0x108>
    1183:	8b 1f                	mov    (%edi),%ebx
    1185:	8b 53 04             	mov    0x4(%ebx),%edx
    1188:	eb 0f                	jmp    1199 <malloc+0x49>
    ...
    1190:	8b 03                	mov    (%ebx),%eax
        printf(1,"inside loop p->s.size = %d\n",p->s.size);
    1192:	89 df                	mov    %ebx,%edi
    1194:	8b 50 04             	mov    0x4(%eax),%edx
    1197:	89 c3                	mov    %eax,%ebx
    1199:	83 ec 04             	sub    $0x4,%esp
    119c:	52                   	push   %edx
    119d:	68 63 15 00 00       	push   $0x1563
    11a2:	6a 01                	push   $0x1
    11a4:	e8 c7 fc ff ff       	call   e70 <printf>
        if(p->s.size >= nunits){
    11a9:	8b 43 04             	mov    0x4(%ebx),%eax
    11ac:	83 c4 10             	add    $0x10,%esp
    11af:	39 f0                	cmp    %esi,%eax
    11b1:	73 3d                	jae    11f0 <malloc+0xa0>
            }
        ...
        if(p == freep){
    11b3:	39 1d c4 1c 00 00    	cmp    %ebx,0x1cc4
    11b9:	75 d5                	jne    1190 <malloc+0x40>
            printf(1, "calling morecore: 0x%x\n", p);
    11bb:	83 ec 04             	sub    $0x4,%esp
    11be:	53                   	push   %ebx
    11bf:	68 c7 15 00 00       	push   $0x15c7
    11c4:	6a 01                	push   $0x1
    11c6:	e8 a5 fc ff ff       	call   e70 <printf>
            if((p = morecore(nunits,0)) == 0)
    11cb:	31 d2                	xor    %edx,%edx
    11cd:	89 f0                	mov    %esi,%eax
    11cf:	e8 fc fe ff ff       	call   10d0 <morecore>
    11d4:	83 c4 10             	add    $0x10,%esp
    11d7:	85 c0                	test   %eax,%eax
    11d9:	89 c3                	mov    %eax,%ebx
    11db:	75 b3                	jne    1190 <malloc+0x40>
                return 0;
    }}
}
    ...
    11e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits){
    11f0:	74 46                	je     1238 <malloc+0xe8>
                printf(1,"p->s.size (%d) =! nunits(%d)\n",p->s.size,nunits);
    11f2:	56                   	push   %esi
    11f3:	50                   	push   %eax
    11f4:	68 9a 15 00 00       	push   $0x159a
    11f9:	6a 01                	push   $0x1
    11fb:	e8 70 fc ff ff       	call   e70 <printf>
                p->s.size -= nunits;
    1200:	8b 43 04             	mov    0x4(%ebx),%eax
                p->s.size = nunits;
    1203:	83 c4 10             	add    $0x10,%esp
                p->s.size -= nunits;
    1206:	29 f0                	sub    %esi,%eax
    1208:	89 43 04             	mov    %eax,0x4(%ebx)
                p += p->s.size;
    120b:	8d 1c c3             	lea    (%ebx,%eax,8),%ebx
                p->s.size = nunits;
    120e:	89 73 04             	mov    %esi,0x4(%ebx)
            printf(1,"returning p+1\n");
    1211:	83 ec 08             	sub    $0x8,%esp
    1214:	68 b8 15 00 00       	push   $0x15b8
    1219:	6a 01                	push   $0x1
    121b:	e8 50 fc ff ff       	call   e70 <printf>
            freep = prevp;
    1220:	89 3d c4 1c 00 00    	mov    %edi,0x1cc4
            return (void*)(p + 1);
    1226:	83 c4 10             	add    $0x10,%esp
}
    1229:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return (void*)(p + 1);
    122c:	8d 43 08             	lea    0x8(%ebx),%eax
}
    122f:	5b                   	pop    %ebx
    1230:	5e                   	pop    %esi
    1231:	5f                   	pop    %edi
    ...
    123b:	56                   	push   %esi
    123c:	68 7f 15 00 00       	push   $0x157f
    1241:	6a 01                	push   $0x1
    1243:	e8 28 fc ff ff       	call   e70 <printf>
                prevp->s.ptr = p->s.ptr;}
    1248:	8b 03                	mov    (%ebx),%eax
    124a:	83 c4 10             	add    $0x10,%esp
    124d:	89 07                	mov    %eax,(%edi)
    124f:	eb c0                	jmp    1211 <malloc+0xc1>
    1251:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"prevp = freep == 0\n");
    1258:	83 ec 08             	sub    $0x8,%esp
        base.s.size = 0;
    125b:	bb c8 1c 00 00       	mov    $0x1cc8,%ebx
        printf(1,"prevp = freep == 0\n");
    1260:	68 4f 15 00 00       	push   $0x154f
    1265:	6a 01                	push   $0x1
        base.s.ptr = freep = prevp = &base;
    1267:	89 df                	mov    %ebx,%edi
        printf(1,"prevp = freep == 0\n");
    1269:	e8 02 fc ff ff       	call   e70 <printf>
        base.s.ptr = freep = prevp = &base;
    126e:	c7 05 c4 1c 00 00 c8 	movl   $0x1cc8,0x1cc4
    1275:	1c 00 00 
    1278:	c7 05 c8 1c 00 00 c8 	movl   $0x1cc8,0x1cc8
    127f:	1c 00 00 
        base.s.size = 0;
    1282:	83 c4 10             	add    $0x10,%esp
    1285:	c7 05 cc 1c 00 00 00 	movl   $0x0,0x1ccc
    128c:	00 00 00 
    128f:	31 d2                	xor    %edx,%edx
    1291:	e9 03 ff ff ff       	jmp    1199 <malloc+0x49>
...
pmalloc(void) {
    ...
    if ((prevp = freep) == 0) {
    12a0:	8b 0d c4 1c 00 00    	mov    0x1cc4,%ecx
pmalloc(void) {
    12a6:	55                   	push   %ebp
    ...
    12ad:	0f 84 95 00 00 00    	je     1348 <pmalloc+0xa8>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
    12b3:	8b 19                	mov    (%ecx),%ebx
        if (p->s.size >= ((4096 / 8)*2)) {
    12b5:	8b 53 04             	mov    0x4(%ebx),%edx
    12b8:	81 fa ff 03 00 00    	cmp    $0x3ff,%edx
    12be:	76 1d                	jbe    12dd <pmalloc+0x3d>
    12c0:	eb 3f                	jmp    1301 <pmalloc+0x61>
    12c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
    12c8:	8b 03                	mov    (%ebx),%eax
        if (p->s.size >= ((4096 / 8)*2)) {
    12ca:	8b 50 04             	mov    0x4(%eax),%edx
    12cd:	81 fa ff 03 00 00    	cmp    $0x3ff,%edx
    12d3:	77 30                	ja     1305 <pmalloc+0x65>
    12d5:	8b 0d c4 1c 00 00    	mov    0x1cc4,%ecx
    12db:	89 c3                	mov    %eax,%ebx
            ...
            if (p == freep) {
    12dd:	39 cb                	cmp    %ecx,%ebx
    12df:	75 e7                	jne    12c8 <pmalloc+0x28>
                if ((p = morecore(nunits, 1)) == 0) {
    12e1:	ba 01 00 00 00       	mov    $0x1,%edx
    12e6:	b8 00 02 00 00       	mov    $0x200,%eax
    12eb:	e8 e0 fd ff ff       	call   10d0 <morecore>
    12f0:	85 c0                	test   %eax,%eax
    12f2:	89 c3                	mov    %eax,%ebx
    12f4:	75 d2                	jne    12c8 <pmalloc+0x28>
                    return 0;
                }
            }
        }
    ...
    1300:	c3                   	ret    
        if (p->s.size >= ((4096 / 8)*2)) {
    1301:	89 d8                	mov    %ebx,%eax
    1303:	89 cb                	mov    %ecx,%ebx
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
    1305:	81 e2 00 fe ff ff    	and    $0xfffffe00,%edx
            set_flag((uint) (p + 1), PTE_1, 1);
    130b:	83 ec 04             	sub    $0x4,%esp
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
    130e:	81 ea 01 02 00 00    	sub    $0x201,%edx
            p += p->s.size;
    1314:	8d 34 d0             	lea    (%eax,%edx,8),%esi
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
    1317:	89 50 04             	mov    %edx,0x4(%eax)
            set_flag((uint) (p + 1), PTE_1, 1);
    131a:	83 c6 08             	add    $0x8,%esi
            p->s.size = nunits;
    131d:	c7 46 fc 00 02 00 00 	movl   $0x200,-0x4(%esi)
            set_flag((uint) (p + 1), PTE_1, 1);
    1324:	6a 01                	push   $0x1
    1326:	68 00 04 00 00       	push   $0x400
    132b:	56                   	push   %esi
    132c:	e8 89 fa ff ff       	call   dba <set_flag>
            freep = prevp;
    1331:	89 1d c4 1c 00 00    	mov    %ebx,0x1cc4
            return (void *) (p + 1);
    ...
    1344:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.size = 0;
    1348:	b9 c8 1c 00 00       	mov    $0x1cc8,%ecx
        base.s.ptr = freep = prevp = &base;
    134d:	c7 05 c4 1c 00 00 c8 	movl   $0x1cc8,0x1cc4
    1354:	1c 00 00 
    1357:	c7 05 c8 1c 00 00 c8 	movl   $0x1cc8,0x1cc8
    135e:	1c 00 00 
        base.s.size = 0;
    1361:	c7 05 cc 1c 00 00 00 	movl   $0x0,0x1ccc
    1368:	00 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
    136b:	89 cb                	mov    %ecx,%ebx
    136d:	e9 6b ff ff ff       	jmp    12dd <pmalloc+0x3d>
    1372:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1379:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001380 <protect_page>:
...
protect_page(void* ap){
    ...
    1387:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if((int)(ap-8) % PGSIZE != 0){
    138a:	8d 43 f8             	lea    -0x8(%ebx),%eax
    138d:	a9 ff 0f 00 00       	test   $0xfff,%eax
    1392:	75 3c                	jne    13d0 <protect_page+0x50>
        return -1;
    }
    int flags = get_flags((uint)ap);
    1394:	83 ec 0c             	sub    $0xc,%esp
    1397:	53                   	push   %ebx
    1398:	e8 15 fa ff ff       	call   db2 <get_flags>
    if (flags & PTE_1) {
    139d:	83 c4 10             	add    $0x10,%esp
    13a0:	f6 c4 04             	test   $0x4,%ah
    13a3:	74 2b                	je     13d0 <protect_page+0x50>
        set_flag((uint) ap, PTE_W, 0);
    13a5:	83 ec 04             	sub    $0x4,%esp
    13a8:	6a 00                	push   $0x0
    13aa:	6a 02                	push   $0x2
    13ac:	53                   	push   %ebx
    13ad:	e8 08 fa ff ff       	call   dba <set_flag>
        update_protected_pages(1);
    13b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13b9:	e8 04 fa ff ff       	call   dc2 <update_protected_pages>
        return 1;
    ...
    13d5:	eb ef                	jmp    13c6 <protect_page+0x46>
...
int pfree(void *ap){
    ...
    int flags = get_flags((uint) ap);
    13ea:	53                   	push   %ebx
    13eb:	e8 c2 f9 ff ff       	call   db2 <get_flags>
    if (!(flags & PTE_W)) set_flag((uint) ap, PTE_W, 1);
    13f0:	83 c4 10             	add    $0x10,%esp
    13f3:	a8 02                	test   $0x2,%al
    13f5:	75 31                	jne    1428 <pfree+0x48>
    13f7:	83 ec 04             	sub    $0x4,%esp
    13fa:	6a 01                	push   $0x1
    13fc:	6a 02                	push   $0x2
    13fe:	53                   	push   %ebx
    13ff:	e8 b6 f9 ff ff       	call   dba <set_flag>
    else
        return -1;

    free(ap);
    1404:	89 1c 24             	mov    %ebx,(%esp)
    1407:	e8 34 fc ff ff       	call   1040 <free>
    update_protected_pages(0);
    140c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    1413:	e8 aa f9 ff ff       	call   dc2 <update_protected_pages>
    return 1;
    1418:	83 c4 10             	add    $0x10,%esp
    141b:	b8 01 00 00 00       	mov    $0x1,%eax
    1420:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1423:	c9                   	leave  
    1424:	c3                   	ret    
    1425:	8d 76 00             	lea    0x0(%esi),%esi
        return -1;
    1428:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    142d:	eb f1                	jmp    1420 <pfree+0x40>
