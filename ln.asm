 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 00 0a 00 00 	movzbl 0xa00(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb f7 09 00 00       	mov    $0x9f7,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 5e1:	a1 08 0e 00 00       	mov    0xe08,%eax
free(void *ap) {
 ...
 61d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 61f:	a3 08 0e 00 00       	mov    %eax,0xe08
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
free(void *ap) {
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 65a:	a3 08 0e 00 00       	mov    %eax,0xe08
        p->s.size += bp->s.size;
 ...
 671:	3d ff 0f 00 00       	cmp    $0xfff,%eax
{
 ...
 6b7:	e8 24 ff ff ff       	call   5e0 <free>
    return freep;
 6bc:	a1 08 0e 00 00       	mov    0xe08,%eax
...
malloc(uint nbytes)
{
 ...
 70d:	e8 fe fc ff ff       	call   410 <printf>
    if((prevp = freep) == 0){
 712:	8b 3d 08 0e 00 00    	mov    0xe08,%edi
 ...
 7b4:	68 98 0a 00 00       	push   $0xa98
 7b9:	6a 01                	push   $0x1
 7bb:	e8 50 fc ff ff       	call   410 <printf>
            freep = prevp;
 7c0:	89 3d 08 0e 00 00    	mov    %edi,0xe08
            return (void*)(p + 1);
 ...
 7f8:	83 ec 08             	sub    $0x8,%esp
        base.s.size = 0;
 7fb:	bb 0c 0e 00 00       	mov    $0xe0c,%ebx
        printf(1,"prevp = freep == 0\n");
 800:	68 2f 0a 00 00       	push   $0xa2f
 805:	6a 01                	push   $0x1
        base.s.ptr = freep = prevp = &base;
 ...
 809:	e8 02 fc ff ff       	call   410 <printf>
        base.s.ptr = freep = prevp = &base;
 80e:	c7 05 08 0e 00 00 0c 	movl   $0xe0c,0xe08
 815:	0e 00 00 
 818:	c7 05 0c 0e 00 00 0c 	movl   $0xe0c,0xe0c
 81f:	0e 00 00 
        base.s.size = 0;
 822:	83 c4 10             	add    $0x10,%esp
 825:	c7 05 10 0e 00 00 00 	movl   $0x0,0xe10
 82c:	00 00 00 
...
pmalloc(void) {
    ...
    if ((prevp = freep) == 0) {
 840:	8b 0d 08 0e 00 00    	mov    0xe08,%ecx
pmalloc(void) {
 846:	55                   	push   %ebp
 ...
 875:	8b 0d 08 0e 00 00    	mov    0xe08,%ecx
 ...
 8cc:	e8 89 fa ff ff       	call   35a <set_flag>
            freep = prevp;
 8d1:	89 1d 08 0e 00 00    	mov    %ebx,0xe08
            return (void *) (p + 1);
 ...
 8e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.size = 0;
 8e8:	b9 0c 0e 00 00       	mov    $0xe0c,%ecx
        base.s.ptr = freep = prevp = &base;
 8ed:	c7 05 08 0e 00 00 0c 	movl   $0xe0c,0xe08
 8f4:	0e 00 00 
 8f7:	c7 05 0c 0e 00 00 0c 	movl   $0xe0c,0xe0c
 8fe:	0e 00 00 
        base.s.size = 0;
 901:	c7 05 10 0e 00 00 00 	movl   $0x0,0xe10
 908:	00 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
