 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 24 0a 00 00 	movzbl 0xa24(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 1d 0a 00 00       	mov    $0xa1d,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 601:	a1 34 0e 00 00       	mov    0xe34,%eax
free(void *ap) {
 ...
 63d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 63f:	a3 34 0e 00 00       	mov    %eax,0xe34
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
free(void *ap) {
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 67a:	a3 34 0e 00 00       	mov    %eax,0xe34
        p->s.size += bp->s.size;
 ...
 691:	3d ff 0f 00 00       	cmp    $0xfff,%eax
{
 ...
 6d7:	e8 24 ff ff ff       	call   600 <free>
    return freep;
 6dc:	a1 34 0e 00 00       	mov    0xe34,%eax
...
malloc(uint nbytes)
{
 ...
 72d:	e8 fe fc ff ff       	call   430 <printf>
    if((prevp = freep) == 0){
 732:	8b 3d 34 0e 00 00    	mov    0xe34,%edi
 ...
 7d4:	68 bc 0a 00 00       	push   $0xabc
 7d9:	6a 01                	push   $0x1
 7db:	e8 50 fc ff ff       	call   430 <printf>
            freep = prevp;
 7e0:	89 3d 34 0e 00 00    	mov    %edi,0xe34
            return (void*)(p + 1);
 ...
 818:	83 ec 08             	sub    $0x8,%esp
        base.s.size = 0;
 81b:	bb 38 0e 00 00       	mov    $0xe38,%ebx
        printf(1,"prevp = freep == 0\n");
 820:	68 53 0a 00 00       	push   $0xa53
 825:	6a 01                	push   $0x1
        base.s.ptr = freep = prevp = &base;
 ...
 829:	e8 02 fc ff ff       	call   430 <printf>
        base.s.ptr = freep = prevp = &base;
 82e:	c7 05 34 0e 00 00 38 	movl   $0xe38,0xe34
 835:	0e 00 00 
 838:	c7 05 38 0e 00 00 38 	movl   $0xe38,0xe38
 83f:	0e 00 00 
        base.s.size = 0;
 842:	83 c4 10             	add    $0x10,%esp
 845:	c7 05 3c 0e 00 00 00 	movl   $0x0,0xe3c
 84c:	00 00 00 
...
pmalloc(void) {
    ...
    if ((prevp = freep) == 0) {
 860:	8b 0d 34 0e 00 00    	mov    0xe34,%ecx
pmalloc(void) {
 866:	55                   	push   %ebp
 ...
 895:	8b 0d 34 0e 00 00    	mov    0xe34,%ecx
 ...
 8ec:	e8 89 fa ff ff       	call   37a <set_flag>
            freep = prevp;
 8f1:	89 1d 34 0e 00 00    	mov    %ebx,0xe34
            return (void *) (p + 1);
 ...
 904:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.size = 0;
 908:	b9 38 0e 00 00       	mov    $0xe38,%ecx
        base.s.ptr = freep = prevp = &base;
 90d:	c7 05 34 0e 00 00 38 	movl   $0xe38,0xe34
 914:	0e 00 00 
 917:	c7 05 38 0e 00 00 38 	movl   $0xe38,0xe38
 91e:	0e 00 00 
        base.s.size = 0;
 921:	c7 05 3c 0e 00 00 00 	movl   $0x0,0xe3c
 928:	00 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
