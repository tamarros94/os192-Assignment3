 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 00 12 00 00    	lea    0x1200(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 00 12 00 00       	mov    $0x1200,%ebx
    buf[m] = '\0';
 26c:	c6 86 00 12 00 00 00 	movb   $0x0,0x1200(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 00 12 00 00    	cmp    $0x1200,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 00 12 00 00       	sub    $0x1200,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 00 12 00 00       	push   $0x1200
 ...
 649:	85 d2                	test   %edx,%edx
{
 ...
 677:	f7 f1                	div    %ecx
 679:	0f b6 92 e0 0c 00 00 	movzbl 0xce0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 894:	e9 8f fe ff ff       	jmp    728 <printf+0x48>
          s = "(null)";
 899:	bb d6 0c 00 00       	mov    $0xcd6,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 8b1:	a1 e0 11 00 00       	mov    0x11e0,%eax
free(void *ap) {
 ...
 8ed:	89 08                	mov    %ecx,(%eax)
    freep = p;
 8ef:	a3 e0 11 00 00       	mov    %eax,0x11e0
}
 8f4:	5b                   	pop    %ebx
 8f5:	5e                   	pop    %esi
 8f6:	5f                   	pop    %edi
...
free(void *ap) {
 ...
 927:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 92a:	a3 e0 11 00 00       	mov    %eax,0x11e0
        p->s.size += bp->s.size;
 ...
 941:	3d ff 0f 00 00       	cmp    $0xfff,%eax
{
 ...
 987:	e8 24 ff ff ff       	call   8b0 <free>
    return freep;
 98c:	a1 e0 11 00 00       	mov    0x11e0,%eax
...
malloc(uint nbytes)
{
 ...
 9dd:	e8 fe fc ff ff       	call   6e0 <printf>
    if((prevp = freep) == 0){
 9e2:	8b 3d e0 11 00 00    	mov    0x11e0,%edi
 ...
 a84:	68 78 0d 00 00       	push   $0xd78
 a89:	6a 01                	push   $0x1
 a8b:	e8 50 fc ff ff       	call   6e0 <printf>
            freep = prevp;
 a90:	89 3d e0 11 00 00    	mov    %edi,0x11e0
            return (void*)(p + 1);
 ...
 ac8:	83 ec 08             	sub    $0x8,%esp
        base.s.size = 0;
 acb:	bb e4 11 00 00       	mov    $0x11e4,%ebx
        printf(1,"prevp = freep == 0\n");
 ad0:	68 0f 0d 00 00       	push   $0xd0f
 ad5:	6a 01                	push   $0x1
        base.s.ptr = freep = prevp = &base;
 ...
 ad9:	e8 02 fc ff ff       	call   6e0 <printf>
        base.s.ptr = freep = prevp = &base;
 ade:	c7 05 e0 11 00 00 e4 	movl   $0x11e4,0x11e0
 ae5:	11 00 00 
 ae8:	c7 05 e4 11 00 00 e4 	movl   $0x11e4,0x11e4
 aef:	11 00 00 
        base.s.size = 0;
 af2:	83 c4 10             	add    $0x10,%esp
 af5:	c7 05 e8 11 00 00 00 	movl   $0x0,0x11e8
 afc:	00 00 00 
...
pmalloc(void) {
    ...
    if ((prevp = freep) == 0) {
 b10:	8b 0d e0 11 00 00    	mov    0x11e0,%ecx
pmalloc(void) {
 b16:	55                   	push   %ebp
 ...
 b45:	8b 0d e0 11 00 00    	mov    0x11e0,%ecx
 ...
 b9c:	e8 89 fa ff ff       	call   62a <set_flag>
            freep = prevp;
 ba1:	89 1d e0 11 00 00    	mov    %ebx,0x11e0
            return (void *) (p + 1);
 ...
 bb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.size = 0;
 bb8:	b9 e4 11 00 00       	mov    $0x11e4,%ecx
        base.s.ptr = freep = prevp = &base;
 bbd:	c7 05 e0 11 00 00 e4 	movl   $0x11e4,0x11e0
 bc4:	11 00 00 
 bc7:	c7 05 e4 11 00 00 e4 	movl   $0x11e4,0x11e4
 bce:	11 00 00 
        base.s.size = 0;
 bd1:	c7 05 e8 11 00 00 00 	movl   $0x0,0x11e8
 bd8:	00 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
