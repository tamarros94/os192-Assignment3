...
00000442 <update_protected_pages>:
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 dc 0a 00 00 	movzbl 0xadc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb d3 0a 00 00       	mov    $0xad3,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 6c1:	a1 ec 0e 00 00       	mov    0xeec,%eax
free(void *ap) {
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
    freep = p;
 6ff:	a3 ec 0e 00 00       	mov    %eax,0xeec
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
...
free(void *ap) {
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 73a:	a3 ec 0e 00 00       	mov    %eax,0xeec
        p->s.size += bp->s.size;
...
morecore(uint nu, int pmalloced)
{
 ...
 751:	3d ff 0f 00 00       	cmp    $0xfff,%eax
{
 ...
 75a:	89 c3                	mov    %eax,%ebx
    if(nu < 4096 && !pmalloced)
 75c:	77 52                	ja     7b0 <morecore+0x60>
 75e:	83 e2 01             	and    $0x1,%edx
 761:	75 4d                	jne    7b0 <morecore+0x60>
 ...
 770:	53                   	push   %ebx
 771:	68 ed 0a 00 00       	push   $0xaed
 776:	6a 01                	push   $0x1
 778:	e8 73 fd ff ff       	call   4f0 <printf>
    p = sbrk(nu * sizeof(Header));
 77d:	89 34 24             	mov    %esi,(%esp)
 780:	e8 95 fc ff ff       	call   41a <sbrk>
    if(p == (char*)-1)
 785:	83 c4 10             	add    $0x10,%esp
 788:	83 f8 ff             	cmp    $0xffffffff,%eax
 78b:	74 33                	je     7c0 <morecore+0x70>
        return 0;
    hp = (Header*)p;
    hp->s.size = nu;
 ...
 796:	50                   	push   %eax
 797:	e8 24 ff ff ff       	call   6c0 <free>
    return freep;
 79c:	a1 ec 0e 00 00       	mov    0xeec,%eax
 ...
 7b7:	eb b4                	jmp    76d <morecore+0x1d>
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        return 0;
 7c0:	31 c0                	xor    %eax,%eax
 7c2:	eb e0                	jmp    7a4 <morecore+0x54>
...
malloc(uint nbytes)
{
 ...
 7d9:	8b 75 08             	mov    0x8(%ebp),%esi
    Header *p, *prevp;
    uint nunits;
    printf(1, "nbytes:%d\n",nbytes);
 7dc:	56                   	push   %esi
 7dd:	68 00 0b 00 00       	push   $0xb00
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7e2:	83 c6 07             	add    $0x7,%esi
    printf(1, "nbytes:%d\n",nbytes);
 7e5:	6a 01                	push   $0x1
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7e7:	c1 ee 03             	shr    $0x3,%esi
 7ea:	83 c6 01             	add    $0x1,%esi
    printf(1, "nbytes:%d\n",nbytes);
 7ed:	e8 fe fc ff ff       	call   4f0 <printf>
    if((prevp = freep) == 0){
 7f2:	8b 3d ec 0e 00 00    	mov    0xeec,%edi
 7f8:	83 c4 10             	add    $0x10,%esp
 7fb:	85 ff                	test   %edi,%edi
 7fd:	0f 84 d5 00 00 00    	je     8d8 <malloc+0x108>
 803:	8b 1f                	mov    (%edi),%ebx
 805:	8b 53 04             	mov    0x4(%ebx),%edx
 808:	eb 0f                	jmp    819 <malloc+0x49>
 ...
 812:	89 df                	mov    %ebx,%edi
 814:	8b 50 04             	mov    0x4(%eax),%edx
 817:	89 c3                	mov    %eax,%ebx
 819:	83 ec 04             	sub    $0x4,%esp
 81c:	52                   	push   %edx
 81d:	68 1f 0b 00 00       	push   $0xb1f
 822:	6a 01                	push   $0x1
 824:	e8 c7 fc ff ff       	call   4f0 <printf>
        if(p->s.size >= nunits){
 829:	8b 43 04             	mov    0x4(%ebx),%eax
 82c:	83 c4 10             	add    $0x10,%esp
 82f:	39 f0                	cmp    %esi,%eax
 831:	73 3d                	jae    870 <malloc+0xa0>
            }
        ...
        if(p == freep){
 833:	39 1d ec 0e 00 00    	cmp    %ebx,0xeec
 839:	75 d5                	jne    810 <malloc+0x40>
            printf(1, "calling morecore: 0x%x\n", p);
 83b:	83 ec 04             	sub    $0x4,%esp
 83e:	53                   	push   %ebx
 83f:	68 83 0b 00 00       	push   $0xb83
 844:	6a 01                	push   $0x1
 846:	e8 a5 fc ff ff       	call   4f0 <printf>
            if((p = morecore(nunits,0)) == 0)
 84b:	31 d2                	xor    %edx,%edx
 84d:	89 f0                	mov    %esi,%eax
 84f:	e8 fc fe ff ff       	call   750 <morecore>
 854:	83 c4 10             	add    $0x10,%esp
 857:	85 c0                	test   %eax,%eax
 859:	89 c3                	mov    %eax,%ebx
 85b:	75 b3                	jne    810 <malloc+0x40>
                return 0;
    }}
}
 ...
 869:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits){
 870:	74 46                	je     8b8 <malloc+0xe8>
                printf(1,"p->s.size (%d) =! nunits(%d)\n",p->s.size,nunits);
 872:	56                   	push   %esi
 873:	50                   	push   %eax
 874:	68 56 0b 00 00       	push   $0xb56
 879:	6a 01                	push   $0x1
 87b:	e8 70 fc ff ff       	call   4f0 <printf>
                p->s.size -= nunits;
 880:	8b 43 04             	mov    0x4(%ebx),%eax
                p->s.size = nunits;
 883:	83 c4 10             	add    $0x10,%esp
                p->s.size -= nunits;
 886:	29 f0                	sub    %esi,%eax
 888:	89 43 04             	mov    %eax,0x4(%ebx)
                p += p->s.size;
 88b:	8d 1c c3             	lea    (%ebx,%eax,8),%ebx
                p->s.size = nunits;
 88e:	89 73 04             	mov    %esi,0x4(%ebx)
            printf(1,"returning p+1\n");
 891:	83 ec 08             	sub    $0x8,%esp
 894:	68 74 0b 00 00       	push   $0xb74
 899:	6a 01                	push   $0x1
 89b:	e8 50 fc ff ff       	call   4f0 <printf>
            freep = prevp;
 8a0:	89 3d ec 0e 00 00    	mov    %edi,0xeec
            return (void*)(p + 1);
 8a6:	83 c4 10             	add    $0x10,%esp
}
 8a9:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return (void*)(p + 1);
 8ac:	8d 43 08             	lea    0x8(%ebx),%eax
}
 8af:	5b                   	pop    %ebx
 8b0:	5e                   	pop    %esi
 8b1:	5f                   	pop    %edi
 ...
 8bb:	56                   	push   %esi
 8bc:	68 3b 0b 00 00       	push   $0xb3b
 8c1:	6a 01                	push   $0x1
 8c3:	e8 28 fc ff ff       	call   4f0 <printf>
                prevp->s.ptr = p->s.ptr;}
 8c8:	8b 03                	mov    (%ebx),%eax
 8ca:	83 c4 10             	add    $0x10,%esp
 8cd:	89 07                	mov    %eax,(%edi)
 8cf:	eb c0                	jmp    891 <malloc+0xc1>
 8d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"prevp = freep == 0\n");
 8d8:	83 ec 08             	sub    $0x8,%esp
        base.s.size = 0;
 8db:	bb f0 0e 00 00       	mov    $0xef0,%ebx
        printf(1,"prevp = freep == 0\n");
 8e0:	68 0b 0b 00 00       	push   $0xb0b
 8e5:	6a 01                	push   $0x1
        base.s.ptr = freep = prevp = &base;
 8e7:	89 df                	mov    %ebx,%edi
        printf(1,"prevp = freep == 0\n");
 8e9:	e8 02 fc ff ff       	call   4f0 <printf>
        base.s.ptr = freep = prevp = &base;
 8ee:	c7 05 ec 0e 00 00 f0 	movl   $0xef0,0xeec
 8f5:	0e 00 00 
 8f8:	c7 05 f0 0e 00 00 f0 	movl   $0xef0,0xef0
 8ff:	0e 00 00 
        base.s.size = 0;
 902:	83 c4 10             	add    $0x10,%esp
 905:	c7 05 f4 0e 00 00 00 	movl   $0x0,0xef4
 90c:	00 00 00 
 90f:	31 d2                	xor    %edx,%edx
 911:	e9 03 ff ff ff       	jmp    819 <malloc+0x49>
...
pmalloc(void) {
    ...
    if ((prevp = freep) == 0) {
 920:	8b 0d ec 0e 00 00    	mov    0xeec,%ecx
pmalloc(void) {
 926:	55                   	push   %ebp
 ...
 92d:	0f 84 95 00 00 00    	je     9c8 <pmalloc+0xa8>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 933:	8b 19                	mov    (%ecx),%ebx
        if (p->s.size >= ((4096 / 8)*2)) {
 935:	8b 53 04             	mov    0x4(%ebx),%edx
 938:	81 fa ff 03 00 00    	cmp    $0x3ff,%edx
 93e:	76 1d                	jbe    95d <pmalloc+0x3d>
 940:	eb 3f                	jmp    981 <pmalloc+0x61>
 942:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 948:	8b 03                	mov    (%ebx),%eax
        if (p->s.size >= ((4096 / 8)*2)) {
 94a:	8b 50 04             	mov    0x4(%eax),%edx
 94d:	81 fa ff 03 00 00    	cmp    $0x3ff,%edx
 953:	77 30                	ja     985 <pmalloc+0x65>
 955:	8b 0d ec 0e 00 00    	mov    0xeec,%ecx
 95b:	89 c3                	mov    %eax,%ebx
            ...
            if (p == freep) {
 95d:	39 cb                	cmp    %ecx,%ebx
 95f:	75 e7                	jne    948 <pmalloc+0x28>
                if ((p = morecore(nunits, 1)) == 0) {
 961:	ba 01 00 00 00       	mov    $0x1,%edx
 966:	b8 00 02 00 00       	mov    $0x200,%eax
 96b:	e8 e0 fd ff ff       	call   750 <morecore>
 970:	85 c0                	test   %eax,%eax
 972:	89 c3                	mov    %eax,%ebx
 974:	75 d2                	jne    948 <pmalloc+0x28>
                    return 0;
                }
            }
        }
}
 976:	8d 65 f8             	lea    -0x8(%ebp),%esp
                    return 0;
 979:	31 f6                	xor    %esi,%esi
}
 97b:	89 f0                	mov    %esi,%eax
 97d:	5b                   	pop    %ebx
 97e:	5e                   	pop    %esi
 97f:	5d                   	pop    %ebp
 980:	c3                   	ret    
        if (p->s.size >= ((4096 / 8)*2)) {
 981:	89 d8                	mov    %ebx,%eax
 983:	89 cb                	mov    %ecx,%ebx
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
 985:	81 e2 00 fe ff ff    	and    $0xfffffe00,%edx
            set_flag((uint) (p + 1), PTE_1, 1);
 98b:	83 ec 04             	sub    $0x4,%esp
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
 98e:	81 ea 01 02 00 00    	sub    $0x201,%edx
            p += p->s.size;
 994:	8d 34 d0             	lea    (%eax,%edx,8),%esi
            p->s.size =  (p->s.size / page_size -1 ) * page_size -1;
 997:	89 50 04             	mov    %edx,0x4(%eax)
            set_flag((uint) (p + 1), PTE_1, 1);
 99a:	83 c6 08             	add    $0x8,%esi
            p->s.size = nunits;
 99d:	c7 46 fc 00 02 00 00 	movl   $0x200,-0x4(%esi)
            set_flag((uint) (p + 1), PTE_1, 1);
 9a4:	6a 01                	push   $0x1
 9a6:	68 00 04 00 00       	push   $0x400
 9ab:	56                   	push   %esi
 9ac:	e8 89 fa ff ff       	call   43a <set_flag>
            freep = prevp;
 9b1:	89 1d ec 0e 00 00    	mov    %ebx,0xeec
            return (void *) (p + 1);
 9b7:	83 c4 10             	add    $0x10,%esp
}
 9ba:	8d 65 f8             	lea    -0x8(%ebp),%esp
 9bd:	89 f0                	mov    %esi,%eax
 9bf:	5b                   	pop    %ebx
 9c0:	5e                   	pop    %esi
 9c1:	5d                   	pop    %ebp
 9c2:	c3                   	ret    
 ...
 9c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.size = 0;
 9c8:	b9 f0 0e 00 00       	mov    $0xef0,%ecx
        base.s.ptr = freep = prevp = &base;
 9cd:	c7 05 ec 0e 00 00 f0 	movl   $0xef0,0xeec
 9d4:	0e 00 00 
 9d7:	c7 05 f0 0e 00 00 f0 	movl   $0xef0,0xef0
 9de:	0e 00 00 
        base.s.size = 0;
 9e1:	c7 05 f4 0e 00 00 00 	movl   $0x0,0xef4
 9e8:	00 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 9eb:	89 cb                	mov    %ecx,%ebx
 9ed:	e9 6b ff ff ff       	jmp    95d <pmalloc+0x3d>
 9f2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 9f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000a00 <protect_page>:
...
protect_page(void* ap){
 ...
 a0a:	8d 43 f8             	lea    -0x8(%ebx),%eax
 a0d:	a9 ff 0f 00 00       	test   $0xfff,%eax
 a12:	75 3c                	jne    a50 <protect_page+0x50>
        return -1;
    }
    int flags = get_flags((uint)ap);
 a14:	83 ec 0c             	sub    $0xc,%esp
 a17:	53                   	push   %ebx
 a18:	e8 15 fa ff ff       	call   432 <get_flags>
    if (flags & PTE_1) {
 a1d:	83 c4 10             	add    $0x10,%esp
 a20:	f6 c4 04             	test   $0x4,%ah
 a23:	74 2b                	je     a50 <protect_page+0x50>
        set_flag((uint) ap, PTE_W, 0);
 a25:	83 ec 04             	sub    $0x4,%esp
 a28:	6a 00                	push   $0x0
 a2a:	6a 02                	push   $0x2
 a2c:	53                   	push   %ebx
 a2d:	e8 08 fa ff ff       	call   43a <set_flag>
        update_protected_pages(1);
 a32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a39:	e8 04 fa ff ff       	call   442 <update_protected_pages>
        return 1;
 a3e:	83 c4 10             	add    $0x10,%esp
 a41:	b8 01 00 00 00       	mov    $0x1,%eax
 ...
 a55:	eb ef                	jmp    a46 <protect_page+0x46>
...
int pfree(void *ap){
 ...
 a67:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    int flags = get_flags((uint) ap);
 a6a:	53                   	push   %ebx
 a6b:	e8 c2 f9 ff ff       	call   432 <get_flags>
    if (!(flags & PTE_W)) set_flag((uint) ap, PTE_W, 1);
 a70:	83 c4 10             	add    $0x10,%esp
 a73:	a8 02                	test   $0x2,%al
 a75:	75 31                	jne    aa8 <pfree+0x48>
 a77:	83 ec 04             	sub    $0x4,%esp
 a7a:	6a 01                	push   $0x1
 a7c:	6a 02                	push   $0x2
 a7e:	53                   	push   %ebx
 a7f:	e8 b6 f9 ff ff       	call   43a <set_flag>
    else
        return -1;

    free(ap);
 a84:	89 1c 24             	mov    %ebx,(%esp)
 a87:	e8 34 fc ff ff       	call   6c0 <free>
    update_protected_pages(0);
 a8c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 a93:	e8 aa f9 ff ff       	call   442 <update_protected_pages>
    return 1;
